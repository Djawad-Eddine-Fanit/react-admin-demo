  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="pointer-events-none absolute inset-0 opacity-30 bg-[radial-gradient(circle_at_30%_20%,hsl(var(--sidebar-primary)/0.25),transparent_60%),radial-gradient(circle_at_80%_70%,hsl(var(--sidebar-accent)/0.25),transparent_55%)]" />
          {children}
        </div>
      </div>
    </div>
